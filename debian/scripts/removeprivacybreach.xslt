...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="script[@type='text/javascript' and contains(@src,'googlesyndication')]" />
  <xsl:template match="script[@type='text/javascript' and contains(text(),'google_ad')]" />
  <xsl:template match="script[@type='text/javascript' and contains(comment(),'google_ad')]" />
  <xsl:template match="script[@type='text/javascript' and contains(text(),'apis.google.com/js/plusone.js')]" />
  ...
  <xsl:template match="script[@type='text/javascript' and contains(@src,'pagead/show_ads.js')]" />
  <xsl:template match="script[@type='text/javascript' and contains(text(),'document.getElementById(&quot;gplusone&quot;)')]" />
  <xsl:template match="adsense" />
  <xsl:template match="CustomSearchEngine" />
  <xsl:template match="script[contains(@src,'google.com/jsapi')]" />
  <xsl:template match="script[@type='text/javascript' and contains(text(),'google.search.CustomSearchControl')]" />
  <xsl:template match="script[contains(@src,'adsbygoogle')]" />
  <xsl:template match="script[contains(text(),'window.adsbygoogle')]" />

  <!-- flattr -->
  <xsl:template match="script[@type='text/javascript' and contains(text(),'http://api.flattr.com/js/0.6/load.js?mode=auto')]" />
  ...
  <xsl:template match="script[@type='text/javascript' and contains(@src,'jquery.min.js')]">
    <xsl:copy>
  ...
  <xsl:template match="script[@type='text/javascript' and contains(@src,'jquery.mousewheel')]">
    <xsl:copy>
      <xsl:apply-templates select="@*"/>
      <xsl:attribute name="src">
  ...
  <xsl:template match="script[@type='text/javascript' and contains(@src,'jquery.fancybox.pack.js')]">
    <xsl:copy>
      <xsl:apply-templates select="@*"/>
      <xsl:attribute name="src">
  ...
  <xsl:template match="link[@type='text/css' and contains(@href,'jquery.fancybox.css')]">
    <xsl:copy>
      <xsl:apply-templates select="@*"/>
  ...
  <xsl:template match="script[@type='text/javascript' and contains(@src,'jquery.fancybox-buttons.js')]" />
  <xsl:template match="script[@type='text/javascript' and contains(@src,'jquery.fancybox-media.js')]" />
  <xsl:template match="link[@type='text/css' and contains(@href,'jquery.fancybox-thumbs.css')]" />
  <xsl:template match="script[@type='text/javascript' and contains(@src,'jquery.fancybox-thumbs.js')]" />
